...
class FormBuku(QWidget):
    ...
    def saveImageToAssets(self, sourcePath):
        destFolder = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '../../assets/icons/coverBukuCollection')
    ...
    def confirmEditClicked(self, aidi):
        ...
        self.confirmEdit.emit(self.judulInput.text(), self.kodeInput.text(),"../../assets/icons/coverBukuCollection/" + tempName, self.aidi)
        self.showEditForm.emit(False)
        self.showAddForm.emit(False)
    
    def confirmAddClicked(self):
        tempName = extractName(self.fileName)
        self.confirmAdd.emit(self.judulInput.text(), self.kodeInput.text(), "../../assets/icons/coverBukuCollection/" + tempName)
        self.showEditForm.emit(False)
        self.showAddForm.emit(False)
