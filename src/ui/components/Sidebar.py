...
class Sidebar(QWidget):
    ...
    def setupUi(self):
        ...
        icon = QIcon()
        icon.addFile(u"../../assets/icons/profilePlaceHolder.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u"../../assets/icons/homelogo2.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u"../../assets/icons/daftarBukuLogo.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u"../../assets/icons/daftarAnggotaLogo.png", QSize(), QIcon.Normal, QIcon.Off)
