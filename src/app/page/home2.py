...
"}")
        ...
        self.horizontalLayout_6.addWidget(self.icon_name_widget)
        ...
        self.horizontalLayout_7 = QHBoxLayout(self.daftarBuku)
        ...
        self.horizontalLayout_8 = QHBoxLayout(self.daftarAnggota)
        self.horizontalLayout_8.setObjectName(u"horizontalLayout_8")
        self.label_6 = QLabel(self.daftarAnggota)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setFont(font1)
        self.label_6.setStyleSheet(u"background-color: rgb(170, 0, 0);")
        ...
        self.horizontalLayout_6.addWidget(self.main_menu)
